...
| --metropolis_hastings_chains | --chns | | Number of sampling chains used in Metropolis-Hastings algorithm. | 100 | |
| --metropolis_hastings_chain_burn_in | --bi | | Number of burn-in samples used in Metropolis-Hastings algorithm. | 1000 | |
| --metropolis_hastings_chain_samples | --chn_smpls | | Number of samples after burn-in for each chain used in Metropolis-Hastings algorithm. | 10,000 | |
